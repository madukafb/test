...
namespace Movie_rental
{
    class DBconnection
    {
        ...
        public DBconnection()
        {
            conn = new OracleConnection("Data Source=App8;User ID=ifsapp;Password=ifsapp");
             conn.Open();
        ...
        {
            OracleConnection conn = new OracleConnection("Data Source=App8;User ID=ifsapp;Password=ifsapp");
            conn.Open();
